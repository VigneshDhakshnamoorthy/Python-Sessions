...
np_index = np_current_price.max()
print(f'Company : {np_company[np.where(np_prev_close == np_prev_close.max())]}')
print(f'Prev Close (Rs) : {np_prev_close[np.where(np_prev_close == np_prev_close.max())]}')
print(f'Current Price (Rs) : {np_current_price[np.where(np_prev_close == np_prev_close.max())]}')
print(f'% Change : {np_change[np.where(np_prev_close == np_prev_close.max())]}')
